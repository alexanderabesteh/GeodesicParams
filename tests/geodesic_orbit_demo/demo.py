...
bh_mass = 1
energy = 0.9  #1 #1.1 #1.2
rot = 0.53#0.8
ang_mom = 3#5 #2
light = 1
particle_light = 1
orbittype = "bound"
initials = [0, 35, 0.85, 0.33]
dir_initials = [1, 1]
mCharge = 0
perm = 1
p_mass = 1
...
sol = solve_geodesic_orbit(bh_mass, rot, eCharge, cosmo, nut, mCharge, light, grav, perm, particle_light, energy, ang_mom, carter, orbittype, config, initials, dir_initials)
mino = np.linspace(0, 5.34, 500)
